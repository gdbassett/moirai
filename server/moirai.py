...
# returns a dictionary mapping given ID to DB ID
...
# get the edge by id, delete it, and add the given edge.  Return the new edge ID
...
# get the node by id, delete it, and add the given node.  REturn the new node ID
